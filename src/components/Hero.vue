  ...
  >
    ...
    <div class="relative text-center max-w-5xl">
      <img
        src="/reducedlogo.svg"
        alt="Logo BeanSoft"
        class="bs-reveal mx-auto w-32 sm:w-40 lg:w-48 drop-shadow-[0_0_35px_rgba(255,255,255,0.22)]"
      />

      <p
        class="bs-reveal bs-float-soft mt-6 inline-flex items-center gap-2 rounded-full bs-glass px-4 py-1.5 text-xs font-medium text-cyan-200"
      >
